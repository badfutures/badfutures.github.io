...
The commint is [slices: zero the slice elements discarded by Delete, DeleteFunc, Comp…](https://github.com/golang/go/commit/e21dc702d54e85381a97259db7deec710108279b) and here is an change:
...
For some of the gotchas shown here the solution is to use library functions but for others paying attention is all there is. 
